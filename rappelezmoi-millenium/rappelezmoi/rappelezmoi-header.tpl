...
<div id="box">
	 <form action="{$request_uri|escape:'htmlall':'UTF-8'}" method="post" id="textbox" name="formrappelezmoi" ;>
        ...
        <tr>
			<td></td>
           <td><input type="submit" name="submitrequesttop" id="submitrequesttop" value="{l s='Send' mod='rappelezmoi'}"/><input type="button" class="close_formulaire" value="{l s='Close' mod='rappelezmoi'}" class="close" onclick="showhide('rappelezmoiform');"></td>
        </tr>
		<tr>
